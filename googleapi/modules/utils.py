...
def _get_search_url(query, page=0, per_page=10, lang='en', area='com', ncr=True, time_period=False, sort_by_date=False):
...
def get_html(url):
    ua = UserAgent()
    header = ua.random
    # header = 'Mozilla/5.0 (Windows NT 6.2; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36'
    # header = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_5)\
